...
namespace com.eLumen.Data
{
    ...
    public partial class asmt_perf_description
    {
        public int asmt_perf_description_id { get; set; }
        public string name { get; set; }
        public int asmt_score_level_id { get; set; }
        public Nullable<int> asmt_criteria_id { get; set; }
        public System.DateTime lst_mod_dt { get; set; }
        public int lst_mod_user_id { get; set; }
        public int client_id { get; set; }
        public Nullable<int> asmt_slo_criteria_id { get; set; }
        public Nullable<bool> C_was_unused_sa { get; set; }
    
        public virtual asmt_score_level asmt_score_level { get; set; }
        public virtual asmt_slo_criteria asmt_slo_criteria { get; set; }
    }
}
