...
namespace com.eLumen.CF.Service.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CFRubricType :  IEquatable<CFRubricType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CFRubricType" /> class.
        /// </summary>
        /// <param name="Identifier">Identifier (required).</param>
        /// <param name="Uri">Model Primitive Datatype &#x3D; NormalizedString (required).</param>
        ...
        public CFRubricType(GUIDType Identifier = null, string Uri = null, string Title = null, string Description = null, DateTime? LastChangeDateTime = null)
        {
            // to ensure "Identifier" is required (not null)
            if (Identifier == null)
            {
                throw new InvalidDataException("Identifier is a required property for CFRubricType and cannot be null");
            }
            else
            {
            ...
            if (Uri == null)
            {
                throw new InvalidDataException("Uri is a required property for CFRubricType and cannot be null");
            }
            else
            {
                this.Uri = Uri;
            ...
            {
                throw new InvalidDataException("LastChangeDateTime is a required property for CFRubricType and cannot be null");
            }
            else
            {
        ...
        public CFRubricCriterionSetType Criteria { get; internal set; }
        public CFRubricCriterionLevelSetType CriteriaLevels { get; internal set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CFRubricType)obj);
        }

        /// <summary>
        /// Returns true if CFRubricType instances are equal
        /// </summary>
        /// <param name="other">Instance of CFRubricType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CFRubricType other)
        {
        ...
        public static bool operator ==(CFRubricType left, CFRubricType right)
        {
