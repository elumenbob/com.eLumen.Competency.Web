...
namespace com.eLumen.CF.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CFItemTypeType :  IEquatable<CFItemTypeType>
    {
        /// <summary>
        ...
        public CFItemTypeType(GUIDType Identifier = null, string Uri = null, string Title = null, string Description = null, string HierarchyCode = null, string TypeCode = null, DateTime? LastChangeDateTime = null)
        {
            // to ensure "Identifier" is required (not null)
            if (Identifier == null)
            {
                throw new InvalidDataException("Identifier is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
            ...
            if (Uri == null)
            {
                throw new InvalidDataException("Uri is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
                this.Uri = Uri;
            ...
            if (Title == null)
            {
                throw new InvalidDataException("Title is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
                this.Title = Title;
            ...
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("HierarchyCode is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("LastChangeDateTime is a required property for CFItemTypeType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CFItemTypeType)obj);
        }

        /// <summary>
        /// Returns true if CFItemTypeType instances are equal
        /// </summary>
        /// <param name="other">Instance of CFItemTypeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CFItemTypeType other)
        {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hash = hash * 59 + this.TypeCode.GetHashCode();
        ...
        public static bool operator ==(CFItemTypeType left, CFItemTypeType right)
        {
