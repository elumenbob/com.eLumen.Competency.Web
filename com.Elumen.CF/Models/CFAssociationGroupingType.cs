...
{
    /// <summary>
    /// This is the container for information about a set of associations that have been labelled as a group (the nature of the group being defined by this container). ED NOTE 2: Should mandatory the &#39;groupCode&#39; attribute be added - this is in the CFTF 0.4.3 (Final) doc but not the JSON example.
    /// </summary>
    [DataContract]
    public partial class CFAssociationGroupingType :  IEquatable<CFAssociationGroupingType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CFAssociationGroupingType" /> class.
        /// </summary>
        ...
        public CFAssociationGroupingType(GUIDType Identifier = null, string Uri = null, string Title = null, string Description = null, DateTime? LastChangeDateTime = null)
        {
            // to ensure "Identifier" is required (not null)
            if (Identifier == null)
            {
                throw new InvalidDataException("Identifier is a required property for CFAssociationGroupingType and cannot be null");
            }
            else
            {
            ...
            if (Uri == null)
            {
                throw new InvalidDataException("Uri is a required property for CFAssociationGroupingType and cannot be null");
            }
            else
            {
                this.Uri = Uri;
            ...
            if (Title == null)
            {
                throw new InvalidDataException("Title is a required property for CFAssociationGroupingType and cannot be null");
            }
            else
            {
                this.Title = Title;
            ...
            {
                throw new InvalidDataException("LastChangeDateTime is a required property for CFAssociationGroupingType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CFAssociationGroupingType)obj);
        }

        /// <summary>
        /// Returns true if CFAssociationGroupingType instances are equal
        /// </summary>
        /// <param name="other">Instance of CFAssociationGroupingType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CFAssociationGroupingType other)
        {
        ...
        public static bool operator ==(CFAssociationGroupingType left, CFAssociationGroupingType right)
        {
