...
namespace com.eLumen.Standard.Models
{
    ...
    public partial class CompetencyRelationshipType :  IEquatable<CompetencyRelationshipType>
    {
        ...
        /// </summary>
        public GUIDType CompetencyRelationshipGUID { get; set; }

        /// <summary>
        /// Gets or Sets CompetencyRelationshipType
        /// </summary>
        public string COMPETENCY_RELATIONSHIP_TYPE { get; set; }

        /// <summary>
        /// Gets or Sets CompetencyFrom
        /// </summary>
        public GUIDType CompetencyFrom { get; set; }

        /// <summary>
        /// Gets or Sets CompetencyTo
        /// </summary>
        public GUIDType CompetencyTo { get; set; }
...
sb.Append("  CompetencyRelationshipType: ").Append(COMPETENCY_RELATIONSHIP_TYPE).Append("\n");
...
sb.Append("  Relationship: ").Append(Relationship).Append("\n");
        ...
        public bool Equals(CompetencyRelationshipType other)
        {
            ...
            return 
                ...
                (
                    this.COMPETENCY_RELATIONSHIP_TYPE == other.COMPETENCY_RELATIONSHIP_TYPE ||
                    this.COMPETENCY_RELATIONSHIP_TYPE != null &&
                    this.COMPETENCY_RELATIONSHIP_TYPE.Equals(other.COMPETENCY_RELATIONSHIP_TYPE)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (this.COMPETENCY_RELATIONSHIP_TYPE != null)
                    hash = hash * 59 + this.COMPETENCY_RELATIONSHIP_TYPE.GetHashCode();
